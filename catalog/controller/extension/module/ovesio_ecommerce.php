...
class ControllerExtensionModuleOvesioEcommerce extends Controller {
	...
	public function index() {
        ...
        if($action == 'orders')
        {
            $duration_months = (int)$this->config->get('ovesio_ecommerce_export_duration');
